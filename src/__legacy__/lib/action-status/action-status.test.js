...
jest
  .spyOn(core.summary, 'addRaw')
  .mockImplementation((text, eol) => summaryMock.addRaw(text, eol))
jest
  .spyOn(core.summary, 'addBreak')
  .mockImplementation(() => summaryMock.addBreak())
jest
  .spyOn(core.summary, 'write')
  .mockImplementation(options => summaryMock.write(options))
